...
#   - A .p12 holding both Developer ID identities (Application + Installer).
#     Export the whole set from the CLI without a GUI prompt:
#       security export -k ~/Library/Keychains/login.keychain-db \
#         -t identities -f pkcs12 -P 'a-password' -o certs.p12
...
set_secret_b64 DEVELOPER_ID_CERTS_P12_BASE64 "$CERTS_P12"
